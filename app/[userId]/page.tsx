...
export default function Create() {
  ...
  useEffect(() => {
    // 부모 페이지 아이디
    const pPageSeq = searchParams?.get("page_id");
  ...
  const savePost = async () => {
    ...
    try {
      ...
      if (!pPageSeq && pPageSeq !== "" && pPageSeq !== null) {
        formData.append("p_seq", pPageSeq);
      }

      if (!pageSeq && pageSeq !== "" && pageSeq !== null) {
    ...
    <div style={{ position: "relative", width: "100%", height: "100%" }}>
      ...
      <div
        ...
        style={{
          ...
          height: `calc(100vh - ${useToolBarHeightState + 116}px)`,
          left: `${useMainMenuWidthState}px`,
          marginTop: `${useToolBarHeightState + 16}px`,
        }}
      >
        <EditorProvider
